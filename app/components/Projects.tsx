    ...
    return (
        <section className=' bg1 mt-0.5 h-max sm:h-screen w-full' id='projects'>
            ...
            <div className=' w-full h-max sm:py-24 py-12 rounded-xl flex flex-col justify-center sm:flex-row items-center sm:px-14 p-3.5'>
                <div className="div sm:w-1/2 sm:h-96 sm:py-5 bg4 sm:mx-5 rounded-xl shadow-xl p-5 ">
                    ...
                    <div className={`${raleway.className} text-2xl sm:3xl text1 sm:py-6 sm:px-14 flex sm:flex-row flex-col items-center justify-center `}>
                        <a href="https://github.com/Lakshmanshankar/code-share" className=' bg5 sm:p-3 scale1 rounded-lg  py-2  sm:m-4 hover:bg6 w-full text-center m-1'>Github Source</a>
                        <a href="https://lakshmanshankar.github.io/code-share/" className=' bg5 sm:p-3 scale1 rounded-lg  py-2  sm:m-4 hover:bg6 w-full text-center m-1'> Live Url</a>
                    </div>
                </div>

                <div className="div sm:w-1/2 sm:h-96 sm:py-5 bg4 sm:mx-5 rounded-xl shadow-xl p-5 mt-5">
                    ...
                    <div className={`${raleway.className} text-2xl sm:3xl text1 sm:py-6 sm:px-14 flex sm:flex-row flex-col items-center justify-center `}>
                        <a href="https://github.com/lakshmanshankarc/student-management-system" className=' bg5 scale1 sm:p-3 py-2 rounded-lg sm:m-4 hover:bg6 w-full text-center m-1'>Github Source</a>
                    </div>
                </div>
