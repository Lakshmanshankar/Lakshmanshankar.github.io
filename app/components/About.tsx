...
function About() {
    ...
    return (
        ...
        <section className=' w-full h-max slow sm:pt-32 bg1 mt-0.5 pt-14' id='about' >
            ...
            <p className={`${raleway.className} text-lg sm:text-3xl text2 p-5 sm:p10 sm:flex sm:full justify-center sm:items-center sm:px-40  sm:h-full`}>
                ...
                I am someone who is passionate about building innovative and exciting software applications. I believe that the key to creating truly remarkable software is staying up-to-date with the latest technologies and continuously expanding my skill set.
                <br /><br />
            ...
            <div className={`${raleway.className} text-lg bg5 text1 flex justify-center `}>
