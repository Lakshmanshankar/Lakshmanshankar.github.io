...
---
import ReferenceTable from "@/components/ui/reference.astro";
...
| Title                   | Link |
|------------------------|------|
| React 19 Blog          | [react.dev](https://react.dev/blog/2024/12/05/react-19#server-actions) |
| React Server Functions | [react.dev](https://react.dev/reference/rsc/server-functions) |
| React `use` Hook       | [react.dev](https://react.dev/reference/react/use#streaming-data-from-server-to-client) |
| Next.js Server Actions | [nextjs.org](https://nextjs.org/docs/app/building-your-application/data-fetching/server-actions-and-mutations) |


<ReferenceTable
    references={[
    { title: "React 19 Blog", url: "https://react.dev/blog/2024/12/05/react-19#server-actions" },
    { title: "React Server Functions", url: "https://react.dev/reference/rsc/server-functions" },
    { title: "React use Hook", url: "https://react.dev/reference/react/use#streaming-data-from-server-to-client" },
