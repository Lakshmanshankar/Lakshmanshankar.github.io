...
<Callout type="info" title="Note">
    ...
    monorepo with tailwind and shadcn. All the code for this article is available in
    [Github](https://github.com/Lakshmanshankar/tailwind-v4-shadcn-monorepo-starter).
</Callout>
